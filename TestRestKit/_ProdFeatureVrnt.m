...
- (int16_t)mkg_prod_fetr_vrnt_idValue {
	NSNumber *result = [self mkg_prod_fetr_vrnt_id];
	return [result shortValue];
}

- (void)setMkg_prod_fetr_vrnt_idValue:(int16_t)value_ {
	[self setMkg_prod_fetr_vrnt_id:[NSNumber numberWithShort:value_]];
}

- (int16_t)primitiveMkg_prod_fetr_vrnt_idValue {
	NSNumber *result = [self primitiveMkg_prod_fetr_vrnt_id];
	return [result shortValue];
}

- (void)setPrimitiveMkg_prod_fetr_vrnt_idValue:(int16_t)value_ {
	[self setPrimitiveMkg_prod_fetr_vrnt_id:[NSNumber numberWithShort:value_]];
}
